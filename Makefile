LANGUAGE_NAME := tree-sitter-iec61131
HOMEPAGE_URL := https://github.com/heytalepazguato/tree-sitter-iec61131-st
VERSION := 0.0.1
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/iec61131 '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/iec61131
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/iec61131
